...
public class AmazonDynamoDBDAO {
	...
	public Account accountsGetAccount(String email) {
		...
		if (account == null) {
			...
			GoogleAnalyticsHelper.RecordAsyncEvent(SecurityHelper.generateEncryptedId(account.getEmail()),GoogleAnalyticsHelper.CATEGORY_ACCOUNT,GoogleAnalyticsHelper.ACTION_CREATE_ACCOUNT,"","");
		}
	...
	public int domainUpdateIp(String ipAddress, String domainName, String accountToken) {
	...
	public int domainUpdateIpV6(String ipv6Address, String domainName, String accountToken) {
	...
	public String recreateToken(String email) {
		// GET OLD TOKEN
		Account currentAccount = accountsGetAccount(email);

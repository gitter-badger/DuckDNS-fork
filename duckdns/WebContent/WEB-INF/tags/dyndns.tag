	...
	<c:otherwise>
		<c:set var="divstyle" value="" />
					...
					<div class="tab-pane${divstyle}" id="dyndns">
						...
						any Client that can use this - should be-able to use this. e,g, <a href="/install.jsp?tab=inadyn&domain=${dynattrs.exampleSingleDomain}" style="color:#cccccc;text-decoration:underline;">inadyn</a>
